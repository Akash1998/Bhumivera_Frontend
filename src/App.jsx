...
// --- BHUMIVERA SCIENCE & LUXURY MODULES ---
...
const ProvenanceEngine = lazy(() => import("./pages/ProvenanceEngine.jsx")); // Upgraded from Genuine_test
const SomaticRegistry = lazy(() => import("./pages/SomaticRegistry.jsx"));   // Upgraded from EWarranty
const About = lazy(() => import("./pages/About.jsx"));
const Contact = lazy(() => import("./pages/Contact.jsx"));
const Legal = lazy(() => import("./pages/Legal.jsx"));
const Affiliate = lazy(() => import("./pages/Affiliate.jsx"));

// --- ADMINISTRATIVE & WAREHOUSE PORTALS ---
